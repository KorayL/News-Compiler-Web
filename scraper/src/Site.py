...
class Site(ABC):
    ...
    def set_url(self) -> None:
        """ Sets the URL to the news website. This is the URL from which all articles will be
         ...
         exist. \n
         Implementation is simple: <code>self.url=''</code>. """
        pass
    ...
    def set_source(self) -> None:
        ...
        Implementation is simple: <code>self.source=''</code>"""
        pass
    ...
    def set_category(self) -> None:
        ...
        to follow. \n
        Implementation is simple: <code>self.category=''</code>. """
        pass
    ...
    def get_date(self, html: BeautifulSoup) -> datetime | None:
        ...
        with <code>new Date("[your_timestamp]")</code> in the console (omit the <code>[]</code>).
        <p>
        @param html: BeautifulSoup object of the article HTML of the article.
